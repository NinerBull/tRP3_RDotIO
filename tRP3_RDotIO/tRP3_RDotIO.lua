...
function TRP3RIO_Frame.FixFonts(small)
		...
		if event == "PLAYER_LOGIN" and TRP3RIO_Frame.LoadedStuff == false then
			...
			if TRP3_CharacterTooltip ~= nil then
				...
				TRP3_CharacterTooltip:HookScript("OnShow", function(t)
					...
					local TRP3RIO_MainColor = WHITE_FONT_COLOR
					local TRP3RIO_TitleColor = NORMAL_FONT_COLOR
...
TRP3RIO_Frame.OpenConfigCommand = {
	id = "rio",
...
TRP3_API.slash.registerCommand(TRP3RIO_Frame.OpenConfigCommand);